...
ESX.RegisterServerCallback("suku:getShopItems", function(source, cb, shoptype)
	...
	for i=1, #itemResult, 1 do
		...
		if shoptype == "Taco" then
			for _, v in pairs(Config.Shops.TacoShop.Items) do
				if v.name == itemResult[i].name then
					table.insert(itemShopList, {
						type = "item_standard",
						name = itemInformation[itemResult[i].name].name,
		...
		if shoptype == "YouTool" then
			for _, v in pairs(Config.Shops.YouToolShop.Items) do
				if v.name == itemResult[i].name then
					table.insert(itemShopList, {
						type = "item_standard",
						name = itemInformation[itemResult[i].name].name,
		...
		if shoptype == "HotDog" then
			for _, v in pairs(Config.Shops.HotDogShop.Items) do
				if v.name == itemResult[i].name then
					table.insert(itemShopList, {
						type = "item_standard",
						name = itemInformation[itemResult[i].name].name,
		...
		if shoptype == "StripClubShop" then
			for _, v in pairs(Config.Shops.StripClubShop.Items) do
				if v.name == itemResult[i].name then
					table.insert(itemShopList, {
						type = "item_standard",
						name = itemInformation[itemResult[i].name].name,
		...
		if shoptype == "YellowJackShop" then
			for _, v in pairs(Config.Shops.YellowJackShop.Items) do
				if v.name == itemResult[i].name then
					table.insert(itemShopList, {
						type = "item_standard",
						name = itemInformation[itemResult[i].name].name,
		...
		if shoptype == "BahamaMamasShop" then
			for _, v in pairs(Config.Shops.BahamaMamasShop.Items) do
				if v.name == itemResult[i].name then
					table.insert(itemShopList, {
						type = "item_standard",
						name = itemInformation[itemResult[i].name].name,
		...
		if shoptype == "TequiLaLaShop" then
			for _, v in pairs(Config.Shops.TequiLaLaShop.Items) do
				if v.name == itemResult[i].name then
					table.insert(itemShopList, {
						type = "item_standard",
						name = itemInformation[itemResult[i].name].name,
		...
		if shoptype == "SplitSideComedyShop" then
			for _, v in pairs(Config.Shops.TequiLaLaShop.Items) do
				if v.name == itemResult[i].name then
					table.insert(itemShopList, {
						type = "item_standard",
		...
		if shoptype == "DiamondCasinoShop" then
			for _, v in pairs(Config.Shops.TequiLaLaShop.Items) do
				if v.name == itemResult[i].name then
					table.insert(itemShopList, {
						type = "item_standard",
...
AddEventHandler('suku:buyLicense', function ()
	...
	if xPlayer.getMoney('money') >= Config.LicensePrice then
